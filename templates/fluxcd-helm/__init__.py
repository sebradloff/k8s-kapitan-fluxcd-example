...
class HelmRelease(BaseObj):
    def new(self):
        ...
        self.need("component_version", "component_version list needed")
    ...
    def body(self):
        ...
        self.root.spec.releaseName = self.kwargs.component_version
...
def main(input_params):
    ...
    component_version = input_params.get("component_version")

    obj = BaseObj()
    obj.root.HelmRelease = HelmRelease(name=name, namespace=namespace, chart_name=chart_name, chart_version=chart_version, repository_name=repository_name, helm_values_files=helm_values_files, component_version=component_version)
